  ...
  return (
    <div className="mt-[97px] flex flex-col items-center justify-center">
      ...
      <div className="mt-7 flex flex-row">
        ...
        <a
          href={`https://accounts.google.com/o/oauth2/auth?client_id=${process.env.PUBLIC_GOOGLE_CLIENT_KEY}&redirect_uri=${process.env.NEXT_PUBLIC_BACKEND_URL}/auth/google&response_type=code&scope=https://www.googleapis.com/auth/userinfo.email`}
        >
          <Image
            src="/svg/google.svg"
            alt="google"
