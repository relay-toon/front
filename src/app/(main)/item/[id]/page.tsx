...
export default function ItemPage() {
  ...
  return (
    <div className="mb-[112px]">
      ...
      <div className="ml-auto mr-auto mt-4 flex h-[364px] w-[280px] items-center rounded-md bg-white"></div>
      <div className="my-[15px] ml-auto mr-auto flex h-14 w-[350px] flex-row content-between items-center justify-between bg-[#EAEAEA] px-[15px]">
        <div>참여 멤버</div>
